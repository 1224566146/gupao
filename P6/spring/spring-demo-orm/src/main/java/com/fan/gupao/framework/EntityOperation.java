...
public class EntityOperation<T> {
    ...
    private static final Logger LOGGER = Logger.getLogger(EntityOperation.class);
    ...
    Map<String, PropertyMapping> getPropertyMappings(Map<String, Method> gettrs, Map<String, Method> setters,
                                                     Field[] fields) {
    ...
    private void fillPkFieldAndAllColumn(String pk, Field[] fields) {
        ...
        try {
            ...
            LOGGER.debug("没找到主键列，主键列名必须与属性名相同");
        }
    ...
    public Map<String, Object> parse(T t) {
        ...
        try {
            ...
            for (String columnName : _map.keySet()) {
    ...
    class PropertyMapping {
        ...
        public PropertyMapping(Method getter, Method setter, Field field) {
            ...
            this.columnName = column == null ? ClassMappings.getGetterName(getter) : ("".equals(column.name()) ?
                    ClassMappings.getGetterName(getter) : column.name());
        ...
        void set(Object target, Object value) throws Exception {
            ...
            try {
                ...
                e.printStackTrace();
                /**
                 * 出错原因如果是boolean字段 mysql字段类型设置tinyint(1)
                 */
