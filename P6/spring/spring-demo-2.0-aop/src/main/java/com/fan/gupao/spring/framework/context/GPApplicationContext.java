...
import com.fan.gupao.spring.framework.aop.GPJdkDynamicAopProxy;
...
public class GPApplicationContext {
    ...
    private Map<String, Object> factoryObjectCache = new ConcurrentHashMap<>();
    ...
    private Object instantiateBean(String beanName, GPBeanDefinition beanDefinition) {
        ...
        try {
            ...
            if (this.factoryObjectCache.containsKey(beanName)) {
                instance = this.factoryObjectCache.get(beanName);
            } else {
    ...
    private GPAdvisedSupport instantionAopConfig(GPBeanDefinition beanDefinition) {
        ...
        config.setPoinCut(this.reader.getConfig().getProperty("pointCut"));
