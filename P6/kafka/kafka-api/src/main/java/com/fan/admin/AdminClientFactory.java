...
public class AdminClientFactory {
    ...
    public static AdminClient createAdminClientByProperties(){
        ...
        // 配置Kafka服务的访问地址及端口号
        prop.setProperty(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.105.128:9092");
    ...
    public static AdminClient createAdminClientByMap(){
        ...
        // 配置Kafka服务的访问地址及端口号
        conf.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.105.128:9092");
