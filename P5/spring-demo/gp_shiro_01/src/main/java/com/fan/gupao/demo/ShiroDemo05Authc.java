 ...
 * @date 2020/8/17
 */
public class ShiroDemo05Authc {

    public static void main(String[] args) {

        // 1、获取一个SecurityManager工厂对象 加载对应的配置文件 将相关的配置信息解析到了Ini对象
        Factory<SecurityManager> factory = new IniSecurityManagerFactory("classpath:shiro-customer-authc.ini");
