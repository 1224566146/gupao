...
/**
 * @Description: MeBatis的API，提供给应用层使用
 * @Author: 樊高风
 * @Date: 11:00 2020/5/15
 */
public class DefaultSqlSession {
    ...
    public <T> T selectOne(String statement, Object[] paramter, Class pojo){
        String sql = getConfiguration().getMappedStatement(statement);
        // 打印代理对象时会自动调用toString()方法，触发invoke()
        return executor.query(sql,paramter,pojo);
    }
}
